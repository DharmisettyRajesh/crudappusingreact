...
const Register = () => {
      ...
      .then(async (response) => {
        ...
        if (!response.ok) {
          ...
          if (data.Registration == "success") {
            ...
            setIsLoading(false);
            toast.error(
              "email or id already exits please try with another one"
            );
          }
        }
      })
  ...
  return (
    <React.Fragment>
      ...
      {!isLoading && (
        <div>
          <div className="login-outer-style-register">
          <Link to="/">
              {" "}
              <img
            ...
            <p className="login-p-style"> Register for  Miracle</p>
            <Card className="card-style" >
              <Card.Header className="text-center">Register</Card.Header>
              <Form>
                <Form.Group
                  className="mb-3 input-style-register"
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched1
                        ? `${input1.length < 1 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched2
                        ? `${input2.length < 1 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched3
                        ? `${input3.length < 3 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched4
                        ? `${input4.length < 3 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched5
                        ? `${input5.length <= 3 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched6
                        ? `${input6.length <= 3 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                >
                  ...
                  <Form.Control
                    ...
                    className={`${
                      touched7
                        ? `${input7.length <= 3 ? "inputstyle" : "inputstyle1"}`
                        : ""
                    }`}
                  />
                ...
                <div className="input-button">
                  <Button
                    ...
                    variant="success"
                    type="button"
                    style={{paddingLeft:"8rem",marginLeft:"2rem",paddingRight:"8rem"}}
